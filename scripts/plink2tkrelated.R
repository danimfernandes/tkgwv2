...
if(length(error1)>0) {
  ...
  if(length(error1)==0) {
    ...
    for(line in seq(1:length(combos[,1]))) {
      ...
      comm9 = paste0("grep -F -f comm",samp1,"_",samp2,"_SNPs2 ",freqFile," > comm",samp1,"_",samp2,".frq")
      system(comm9)
      ...
      comm10a = paste0("wc -l comm",samp1,"_",samp2,".frq")
      ...
      if(as.integer(strsplit(system(comm10a, intern=T)," ")[[1]][1]) != as.integer(strsplit(system(comm10b, intern=T)," ")[[1]][1])) {
        comm10c = paste0("awk '{print $2",'" "',"}' comm",samp1,"_",samp2,".frq > comm",samp1,"_",samp2,"_SNPs3")
        system(comm10c)
      ...
      alFreqNew = read.csv(paste0("comm",samp1,"_",samp2,".frq"),stringsAsFactors=FALSE,sep="",colClasses = c(character(),character(),character(),character(),numeric(),numeric()),header = F,col.names = c("CHR","SNP","A1","A2","MAF","NCHROBS"))
